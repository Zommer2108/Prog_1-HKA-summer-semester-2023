...
public class Quersumme {
    ...
    static String quersummeHex(String eingabeZahl) {
        ...
        // Checks if calculating number is a hex number if not we can directly form the
        // digit sum
     ...
     * @return returns either the value when it is not a char or the numeric value
     *         of the corresponding char
     */
